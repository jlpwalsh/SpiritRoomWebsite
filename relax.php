...
<p align="center"><font size="5"><b>Relax</b></font> </p>

<table width="90%"  border="0" align="center" cellpadding="2">
	<tr><td>
<table width="80%" border="0" cellspacing="4" cellpadding="4" align="center">
<?
	$sql="select * from archives where current=1 and section='relax' order by post_date desc, id desc";
	$result=mysql_query($sql) or die($sql.mysql_error());
	while($row=mysql_fetch_object($result)) {		
		$description=stripslashes($row->content);
		$image_url=$row->image_url;		
		$image=($image_url) ? "<img src='archives/relax/$image_url' width=600 />" : "<p align='left' style='width:600px;'>$description</p>";
		$display.="	<tr>
	  <td align='center'>
	  $image
	  </td>
...
<p align="center"><a href="archives.php?d=relax">Archives</a></p>
<?
